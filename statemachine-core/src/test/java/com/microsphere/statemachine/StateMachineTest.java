...
class StateMachineTest {
    ...
    void transitionTest() {
        ...
        final StateContext<String, String> result = statemachine.fire("initial", Param.create());
    ...
    void transitionWrongEventTest() {
        ...
        final StateContext<String, String> result = statemachine.fire("end", Param.create());
    ...
    void parameterTest() {
        ...
        final String initialEvent = "initial";
        final Consumer<StateContext<String, String>> action = ctx -> LOG.info("initial created and get id with {0}", ctx.getParam().get(key, Integer.class), ctx.getParam().get(UserId, Long.class));
        final Transition<String, String> transition = new DefaultTransition<>(
        ...
        final Param params = Param.create();
        params.bind(key, 1);
