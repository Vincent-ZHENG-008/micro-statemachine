...
public class SampleMetricsStateMachineTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SampleMetricsStateMachineTest.class);
    ...
    void rejectSample() throws InterruptedException {
        ...
        final StateContext<String, String> result = statemachine.fire("initial1", Param.create());
    ...
    void noguardSample() throws InterruptedException {
        ...
        try {
            statemachine.fire("initial", Param.create());
